...
import KategoriDalje from "./PergjDalje/KategoriDalje";
import PozicionDalje from "./PergjDalje/PozicionDalje";
...
const PergjegjMagDalje = ({ PergjegjMagDalje }) => {
    ...
    <form onSubmit={() => submitHandler()}>
      ...
      >
        ...
        <div className="border p-2">
          ...
          <div className="flex justify-start items-center">
            <KategoriDalje KategoriDalje={FletedaljeData} />
            <Form.Select
          ...
          <div className="flex justify-start items-center">
            <PozicionDalje KategoriDalje={FletedaljeData} />
            <Form.Select
...
export default PergjegjMagDalje;
