...
import PergjegjesMagazina from "./MagazinaHyje/PergjegjesMagazina";
import QytetiMagazina from "./MagazinaHyje/QytetiMagazina";
import DepartamentMagazina from "./MagazinaHyje/DepartamentMagazina";
import Form from "react-bootstrap/Form";
import Modal from "react-bootstrap/Modal";
import { Dialog } from "primereact/dialog";
import { Checkbox, FormControlLabel, TextField } from "@mui/material";
const MagazinaHyrje = ({ MagazinFletHyrje }) => {
  ...
  const fetchFleteHyrjeData = async () => {
    try {
        ...
        <div className="flex border p-2 gap-4">
          <div>
            ...
            <div className="flex justify-start items-center">
              <PergjegjesMagazina PergjegjesMagazina={fetchFleteHyrjeData} />
            ...
            <div className="flex justify-start items-center">
              <DepartamentMagazina PergjegjesMagazina={fetchFleteHyrjeData} />
              <Form.Select
                style={{ width: "200px" }}
            ...
            <div className="flex justify-start items-center">
              <QytetiMagazina PergjegjesMagazina={fetchFleteHyrjeData} />
              <Form.Select
                style={{ width: "200px" }}
                placeholder="Qyteti"
                disabled={disabled}
