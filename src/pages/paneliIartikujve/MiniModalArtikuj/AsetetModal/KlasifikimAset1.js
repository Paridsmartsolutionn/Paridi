...
const KlasifikimAset1 = ({selektAAmKlasifkim1}) => {
  ...
  const rrjeshta = selektAAmKlasifkim1?.AAM_Klasifikim1
  ...
  return (
    <form onSubmit={()=>submitHanlder()}>
      ...
      <Dialog header="Shtim/Modifikim  AAM_kls1" 
...
export default KlasifikimAset1