...
const KlasifikimAset2 = ({selektAAmKlasifkim2}) => {
  ...
  const rrjeshta = selektAAmKlasifkim2?.AAM_Klasifikim1
  ...
  return (
    <form onSubmit={()=>submitHanlder()}>
      ...
      <Dialog header="Shtim/Modifikim AAM_kls2" 
...
export default KlasifikimAset2