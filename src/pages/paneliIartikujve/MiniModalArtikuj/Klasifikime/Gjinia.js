...
const Gjinia = ({selektGjinia}) => {
  ...
  const rekordet = selektGjinia.Gjinia
 ...
 <Modal centered style={{marginLeft:'1rem',marginTop:'-2rem'}} show={show} onHide={handleClose}>  
    <Modal.Header style={{background:' #1971c2'}} >
      <Modal.Title style={{color:'white',fontSize:'20px'}}><spna style={{color:"#d0ebff "}}>Shtim/Modifikim</spna> Gjinia</Modal.Title>
      <div >
