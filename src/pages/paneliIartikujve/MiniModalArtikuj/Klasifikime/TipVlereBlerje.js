...
const TipVlereBlerje = ({selektVlereBlerje}) => {
  ...
  //   }}
      ...
      const handleChange=(key,value)=>{
        ...
        const [tableShowHide,setTableShowHide]=useState(false)
          ...
          const Rekorde = selektVlereBlerje?.Tip_Vlere_Blerje
          console.log({Rekorde})
  ...
  return (
    ...
    <AddIcon fontSize='small'
      ...
      <Dialog header="Shtim/Modifikim Tip Vlere Blerje" 
