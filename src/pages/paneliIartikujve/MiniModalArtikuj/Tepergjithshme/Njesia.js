 ...
 function changePage(event) {
  ...
  return (
    ...
    <AddIcon fontSize='small'
      ...
      <Dialog header="Shtim/Modifikim Njesia" 
...
<div  className=' border  p-2 flex flex-col '>
    ...
    <div  className='flex mt-3 justify-between ' >
      <div className='border rounded-md  '>
        ...
        <KeyboardDoubleArrowLeftIcon onClick={goToNextPage} className='border-r-2 hover:bg-slate-300 hover:cursor-pointer '/>
        <KeyboardDoubleArrowRightIcon onClick={goToNextPage} className='border-l-2 hover:bg-slate-300 hover:cursor-pointer '/>
      </div>
