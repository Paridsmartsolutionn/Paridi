...
const Tarifat = ({selektTarifa}) => {
  ...
  //   }}
      ...
      const handleChange=(key,value)=>{
        ...
        const [tableShowHide,setTableShowHide]=useState(false)
          ...
          const Tarifa = selektTarifa?.Tarifa
          console.log({Tarifa})
  
        const rrjeshtat = `${Tarifa ? Tarifa.length : 0} Rekorde`
  ...
  return (
    ...
    <AddIcon fontSize='small'
      ...
      <Dialog header="Shtim/Modifikim Tarifat" 
...
<div className='flex justify-between'>
  ...
  <div className='border p-2 flex flex-col mt-2'>
    ...
    <div className='flex items-center'>
  <Checkbox inputId="cb1" value="Dartikull" onChange={onCityChange} checked={cities.includes('Dartikull')}></Checkbox>
  <label  label style={{marginLeft:"5px",fontWeight:500}} htmlFor="cb2" className="p-checkbox-label">Default Artikull</label>
    </div>

    <div className='flex items-center'>
  <Checkbox inputId="cb1" value="Dsherbim" onChange={onCityChange} checked={cities.includes('Dsherbim')}></Checkbox>
  <label  label style={{marginLeft:"5px",fontWeight:500}} htmlFor="cb2" className="p-checkbox-label">Default Sherbim</label>
    </div>

    <div className='flex items-center'>
  <Checkbox inputId="cb1" value="Dllogari" onChange={onCityChange} checked={cities.includes('Dllogari')}></Checkbox>
  <label  label style={{marginLeft:"5px",fontWeight:500}} htmlFor="cb2" className="p-checkbox-label">Default Llogari</label>
    </div>
  </div>
