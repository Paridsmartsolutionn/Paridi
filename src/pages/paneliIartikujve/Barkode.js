...
const Barkode = ({
  ...
  return (
    ...
    <div className='bar_kod' onClick={()=>{if(disabled){setNdryshoKushtin(true)}else{setNdryshoKushtin(false)}}}>
        <div>
        ...
        <Button className='p-1 border' onClick={(e)=>{e.preventDefault();setDisabled(true)}} disabled={disabled}><ClearIcon/></Button>
           ...
           <div className="card">
            ...
            <div className='flex border p-2 gap-3' onClick={()=>{if(disabled){setNdryshoKushtin(true)}else{setNdryshoKushtin(false)}}}>
                <div>
