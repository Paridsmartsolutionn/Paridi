  ...
  return (
    <div className="flex flex-col">
      <div className="border-b flex gap-3 w-6/12">
        <label style={{ color: "#1971c2", fontWeight: 500 }} htmlFor="username">
          Pesha ne KG
        </label>
      ...
      <div className="mt-3 flex flex-col border p-2 w-2/12">
        ...
        <span
          ...
          className="p-float-label mt-3"
        >
          <InputText
            disabled={disabled}
            className="block mb-2"
            type="number"
            placeholder="Volumi m3"
            id="Volumi m3"
          />
      ...
      <div className="border p-2 relative mt-3 w-2/12">
        <span
          ...
          style={{ top: -15, left: 100, color: "#1971c2", fontWeight: 500 }}
        >
          Dimensione
        </span>
