...
<div>
    <div className='flex items-center border p-1 gap-5 mb-2'>
        ...
        <div>
            ...
            <Checkbox
            disabled={disabled} inputId="cb3" value="I perbere" onChange={onCityChange} checked={cities.includes('I perbere')}></Checkbox>
            <label style={{color:"#1971c2",marginLeft:"5px"}} htmlFor="cb4" className="p-checkbox-label">I perbere</label>
            </div>

            <div onClick={()=>{if(disabled){setNdryshoKushtin(true)}else{setNdryshoKushtin(false)}}} className='flex items-center'>
            <Checkbox
            disabled={disabled} inputId="cb3" value="I perbere ne magazine" onChange={onCityChange} checked={cities.includes('I perbere ne magazine')}></Checkbox>
            <label style={{color:"#1971c2",marginLeft:"5px"}} htmlFor="cb4" className="p-checkbox-label">I perbere ne magazine</label>
            </div>
        </div>
