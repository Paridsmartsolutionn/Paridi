          ...
          <div className="flex flex-col justify-center p-2 border-r-2 w-4/12">
            ...
            >
              ...
              <Form.Select
                ...
                value={selektKls2}
                onChange={(e) => {
                  setSelektKls2(e.target.value);
                }}
              >
                <option label="Klasifikim2" />
                {selektKls2?.Art_Klasifikim2?.map((list) => {
                  return <option>{list?.Pershkrim}</option>;
                })}
              </Form.Select>
            </div>
            <div
            ...
            <div
              className="flex items-center border-b-2 mt-2"
              onClick={() => {
                if (disabled) {
                  setNdryshoKushtin(true);
                } else {
          ...
          <div className="flex gap-3 mt-2">
            ...
            >
              ...
              <Form.Select
                ...
                onChange={(e) => {
                  setSelektVlereShitje(e.target.value);
                }}
              >
            ...
            >
              ...
              <Form.Select
                ...
                onChange={(e) => {
                  setSelektVlereBlerje(e.target.value);
                }}
              >
            ...
            >
              ...
              <Form.Select
                ...
                onChange={(e) => {
                  setSelektVlereImport(e.target.value);
                }}
              >
