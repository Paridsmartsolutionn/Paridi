...
import MagazinaHyrje from "./flete-hyrje/minimodals/MagazinaHyrje";
import VeprimiHyrje from "./flete-hyrje/minimodals/Tjera-hyrje/VeprimiHyrje";
import MagazinaOrgHyrje from "./flete-hyrje/minimodals/Tjera-hyrje/MagazinaOrgHyrje";
  ...
  const template = (options) => {
    ...
    return (
      <div className={className}>
        ...
        <span className={titleClassName}>IMPORT</span>
      </div>
    );
  };
