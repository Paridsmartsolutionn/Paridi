      ...
      <div>
        <div className="m-6">
          ...
          <div className="flex justify-between items-center mt-4 mb-4">
            <div
              style={{ borderRadius: "0.6rem", lineHeight: "2" }}
              className="flex flex-col border pr-48 pt-2 pl-2 "
            >
            ...
            <div
              style={{ borderRadius: "0.6rem", lineHeight: "2.1" }}
              className="flex justify-between border pr-2 pt-2 pb-2 pl-6 items-end"
            >
