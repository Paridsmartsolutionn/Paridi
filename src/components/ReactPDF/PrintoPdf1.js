        ...
        <div>
         ...
         style={{marginTop:'15px'}}
          ...
          >
            ...
            <Button style={{color:"#1971c2",cursor:"pointer" ,margin:'5px'}} onClick={handlePrint}> <div style={{fontSize:'12px'}}>Printo Fature Shitje
              </div><PrintSharp style={{blockSize:'17px'}}/> </Button>
            <Button style={{color:"#1971c2",cursor:"pointer" ,margin:'5px'}} > <div style={{fontSize:'12px'}}>Printo Fature Shitje 2
              </div><PrintSharp style={{blockSize:'17px'}}/> </Button>
