  ...
  return (
    <main className="sticky top-0 z-10">
      <section
        ...
        className="  section container h-16  flex justify-around"
      >
        <div className=" flex items-center basis-7">
          <Link
            className="font-bold pss-logo drop-shadow-md  text-white text-5xl "
            to={"/"}
          >
            <h1> PSS</h1>
          </Link>
        ...
        <div
          className="text-white text-lg mt-2.5 mb-2.5 links-outside  font-bold flex
            items-center  py-2 px-3 rounded-md transform hover:bg-blue-400  hover:bg-opacity-30
            transition duration-300 ease-in-out  "
        >
          <Login />
        </div>
        <div className="icona  flex items-center  text-white">
          <Login />
        </div>
      </section>
    </main>
