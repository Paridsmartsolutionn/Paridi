...
//    }
  return (
    ...
    <ToastContainer/>
   <div style={{height:'49rem'}} className='flex  items-center max-w-7xl gap-20'>  
     ...
     <form className='xl:w-1/2 p-16 ' onSubmit={submit}>
        ...
        {!error ? <TextField className='mb-3' variant='outlined' 
         ...
         type="text" value={nipt} onChange={(e)=>setNipt(e.target.value)} /> 
           ...
           <div className='mt-3'>
             <Button fullWidth variant="contained" type='submit' >Regjistrohu</Button>
           </div>
           <div className='mt-3 flex justify-end'>
            <span>Jeni regjistruar! <Link   className='linku' to='/'>Hyni me kredencialet tuaja</Link></span>
           </div>
